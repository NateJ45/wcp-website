...
| **Calendar feed web app**      | Apps Script serving the calendar as JSON ([source](../scripts/apps-script/calendar-feed.gs)); skips "Tour with …" booking events (visitor/child names) | Maintainer's personal account (redeployed 2026-07-17)             | Redeploy from the committed source under any account that can see the calendar; update Site Settings → Calendar feed link.              |
